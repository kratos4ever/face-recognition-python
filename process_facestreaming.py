...
def updateStatusAndResult(data):
	sql = "  insert into imageprocess_status (imagebagid, imageprocessorid, processedon, status, result,num_faces,confidence,distance,result_id) VALUES (%s,1,now(),%s,%s,%s,%s,%s,%s) "
	cur = db.cursor()
